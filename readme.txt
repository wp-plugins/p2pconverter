...
a page or a post to the either, click that link! This only works for roles with the capability 
to delete posts (i.e. Administrators and Editors), which can be specifically modified with a 
Roles plugin.
...
=== Future Plans ===
* Ajaxify the system?
* Work nicer with the search function
...
* Please use this version if you are using a pre-2.5 installation of Wordpress.
